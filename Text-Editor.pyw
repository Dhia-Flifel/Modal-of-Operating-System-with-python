...
class TextEditor:
  ...
  def __init__(self,root):
    ...
    # Initializing Status
    self.status.set("Welcome To DHF-EDIT")
    # Creating Menubar
  ...
  def infoabout(self):
    messagebox.showinfo("About Text Editor","Cyber-EDIT is a simple text editor included with the Cyber-OS")
